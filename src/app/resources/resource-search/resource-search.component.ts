...
export class ResourceSearchComponent implements OnInit {
  ...
  columnDefs = [
    ...
    {headerName: 'Major Field', field: 'candidate.majorField', pinned: 'left'},
    ...
    {headerName: 'Available Time', field: 'candidate.availableTime'},
    {headerName: 'Country', field: 'candidate.country'},
    {headerName: 'Native Language', field: 'candidate.nativeLanguage'},
    {headerName: 'Updated date', field: 'updatedAt', type: 'dateColumn', width: 170, filter: false, cellRenderer: 'dateRender', cellRendererParams: {renderField: 'updatedAt'}},
  ];
  /*AG_GRID*/
  gridApi;
  gridColumnApi;
